...
if [[ $bits = 32bit ]]; then
    ...
    do_cmakeinstall video -DUNIX=OFF -DBUILD_TESTING=OFF -DENABLE_AVX512=ON -DSVT_AV1_LTO=OFF -DCMAKE_CXX_FLAGS_RELEASE="-DNDEBUG -O2" -DCMAKE_C_FLAGS_RELEASE="-DNDEBUG -O2"
    do_checkIfExist
fi
