...
_pre_configure(){
    ...
    FFMPEG_OPTS+=(--enable-swscale --enable-nonfree --enable-pthreads --enable-protocol=file --enable-filter=vpp_amf --enable-filter=sr_amf --h264-max-bit-depth=14 --h265-bit-depths=8,9,10,12)
    #
}
